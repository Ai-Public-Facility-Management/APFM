...
url = "http://localhost:8080/run-report-graph"  
    ...
    "facilities": [
        {
            ...
            "cost_basis": (
                "- 정류장 쉘터 수리: 파손 부위 교체 및 보강 필요. 철재 구조물 보강 및 방풍 유리 교체 기준 적용.\n"
        ...
        },
        {
            ...
            "cost_basis": (
                "- 볼라드 교체: 노후화된 볼라드 1개소 철거 후 신규 설치.\n"
        ...
        },
        {
            ...
            "cost_basis": (
                "- 가로수 지주대 점검: 현재 상태는 양호하나 보완 필요 구간 있음.\n"
